...
function Ninja:check_ninja_colliding(ninja)
    local ninja_x = ninja:get_x()
	local ninja_y = ninja:get_y()

	return self.position_x + Constants.SPRITE_SIZE - Constants.Ninja.BORDER > ninja_x + Constants.Ninja.BORDER and
           self.position_x + Constants.Ninja.BORDER < ninja_x + Constants.SPRITE_SIZE - Constants.Ninja.BORDER and
           self.position_y + Constants.SPRITE_SIZE > ninja_y and
           self.position_y < ninja_y + Constants.SPRITE_SIZE
end

function Ninja:get_x()
    return self.position_x
end

function Ninja:get_y()
...
function Ninja:handle_scoring(level_data, x, y)
end
